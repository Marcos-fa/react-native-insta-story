...
export default class CubeNavigationHorizontal extends React.Component {
    ...
    UNSAFE_componentWillMount() {
        try {
            ...
            crashlytics().recordError(error, 'error instaStory UNSAFE_componentWillMount iosCube');
        }
    }
    ...
    componentWillReceiveProps(props) {
        try {
            ...
            crashlytics().recordError(error, 'error instaStory componentWillReceiveProps iosCube');
        }
    }
    ...
    */
    scrollTo(page, animated) {
        ...
        try {
            ...
            crashlytics().recordError(error, 'error instaStory scrollTo iosCube');
        }
    }
    ...
    */
    ...
    _getTransformsFor = i => {
        try {
            ...
            crashlytics().recordError(error, 'error instaStory _getTransformsFor iosCube');
        }
    };
    ...
    _renderChild = (child, i) => {
        try {
            ...
            crashlytics().recordError(error, 'error instaStory _renderChild iosCube');
        }
    };
    ...
    _closest = num => {
        try {
            ...
            crashlytics().recordError(error, 'error instaStory _closest iosCube');
        }
    };
